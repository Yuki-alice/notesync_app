...
extension TagByIndex on IsarCollection<Tag> {
  ...
  Future<List<Tag?>> getAllById(List<String> idValues) {
    final values = idValues.map((e) => [e]).toList();
    return getAllByIndex(r'id', values);
  }

  List<Tag?> getAllByIdSync(List<String> idValues) {
    final values = idValues.map((e) => [e]).toList();
  ...
  Future<Id> putById(Tag object) {
    return putByIndex(r'id', object);
  }

  Id putByIdSync(Tag object, {bool saveLinks = true}) {
    return putByIndexSync(r'id', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllById(List<Tag> objects) {
    return putAllByIndex(r'id', objects);
  }

  List<Id> putAllByIdSync(List<Tag> objects, {bool saveLinks = true}) {
...
extension TagQueryWhere on QueryBuilder<Tag, Tag, QWhereClause> {
  ...
  QueryBuilder<Tag, Tag, QAfterWhereClause> idEqualTo(String id) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Tag, Tag, QAfterWhereClause> idNotEqualTo(String id) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
