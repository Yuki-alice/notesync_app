...
extension CategoryByIndex on IsarCollection<Category> {
  ...
  Category? getByIdSync(String id) {
  ...
  Future<List<Category?>> getAllById(List<String> idValues) {
    final values = idValues.map((e) => [e]).toList();
    return getAllByIndex(r'id', values);
  }

  List<Category?> getAllByIdSync(List<String> idValues) {
    final values = idValues.map((e) => [e]).toList();
  ...
  Future<Id> putById(Category object) {
    return putByIndex(r'id', object);
  }

  Id putByIdSync(Category object, {bool saveLinks = true}) {
    return putByIndexSync(r'id', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllById(List<Category> objects) {
    return putAllByIndex(r'id', objects);
  }

  List<Id> putAllByIdSync(List<Category> objects, {bool saveLinks = true}) {
...
extension CategoryQueryWhere on QueryBuilder<Category, Category, QWhereClause> {
  ...
  QueryBuilder<Category, Category, QAfterWhereClause> idEqualTo(String id) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Category, Category, QAfterWhereClause> idNotEqualTo(String id) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
